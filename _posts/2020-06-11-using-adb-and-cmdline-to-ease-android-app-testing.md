...
author: Gaurav
excerpt: Using adb and command line can simplify and ease many tasks that are otherwise performed via a UI. In this post, we cover how to use adb/scrcpy to perform some common workflows which are usually done during app testing
layout: post
...
publicize_linkedin_url:
  - null
image: /wp-content/uploads/2020/06/android_phone-1.jpg
categories:
  - Android
  - Mobile Testing
  - Tools and tricks
---
<figure class="wp-block-image size-large"><img loading="lazy" width="750" height="500" src="https://i1.wp.com/automationhacks.blog/wp-content/uploads/2020/06/android_phone.jpg?resize=750%2C500&#038;ssl=1" alt="" class="wp-image-815" data-recalc-dims="1" /><figcaption>Photo by Christian Wiediger on Unsplash</figcaption></figure> 
...
Some of these include:
  ...
  * Copy the apk file over to the real device using **Android File Transfer** (on mac) while ensuring that the MTP mode is enable the file transfer in the first place
...
<img loading="lazy" src="https://i0.wp.com/automationhacks.blog/wp-content/uploads/2020/06/image.png?resize=320%2C709&#038;ssl=1" alt="" class="wp-image-807" width="320" height="709" data-recalc-dims="1" /> <figcaption>A screen shared via scrcpy</figcaption></figure> 
