...
author: Gaurav
layout: post
guid: http://automationhacks.blog/?p=105
...
![](https://cdn-images-1.medium.com/max/1600/0*I-e-cxWuRvRbct55) <figcaption>Source: Unsplash</figcaption></figure> 
...
Well for starter,
  ...
  * Also this creates a dysfunctional scenario wherein someone has to maintain and debug all these 1000+ long running tests that&nbsp;**_oddly_**_sometimes fail. Gosh!_<figure class="wp-block-image">

<img src="https://i2.wp.com/automationhacks.blog/wp-content/uploads/2019/06/1d5f3-0qx6agf7s7ucpucxl.png?w=750&#038;ssl=1" alt="" data-recalc-dims="1" /> <figcaption><a href="https://martinfowler.com/articles/practical-test-pyramid.html" rel="noreferrer noopener" target="_blank">https://martinfowler.com/articles/practical-test-pyramid.html</a></figcaption></figure> 
...
_We don’t need patterns or clean code. A test function which is 100 LOC long is perfectly fine since we are not “real” developers anyways_
...
Have you seen cases like this?
  ...
  * _Tester will ask the dev if he is writing enough unit tests for the feature and would be satisfied with just a verbal response?_
  * _Tester would&nbsp;_rarely_&nbsp;take a look at created code in different pull requests?_
  * _Testing is treated as a separate discipline and feel they should test everything from outside the box_
